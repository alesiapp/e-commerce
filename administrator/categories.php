...
$stmt1=$conn->prepare('select count(*) as total_records from kategoria');
$stmt1->execute();
...
$stmt2=$conn->prepare("select * from kategoria  limit $offset,$total_records_per_page");
$stmt2->execute();
...
<div class="container-fluid">
    ...
    <div class="row" style="min-height: 1000px">
        ...
        <!-- Main content area, including the table -->
                ...
                <table class="table table-stripped table-sm">
                    ...
                    <?php  foreach ($categories as $p) {?>
                        <tr>
                            ...
                            <td><?php echo $p['emri_kategorise'];?></td>
                            <td><?php echo $p['detaje']?></td>
